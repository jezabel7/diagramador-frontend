...
export default function HelpChatWidget() {
  ...
  const [messages, setMessages] = useState([
    { role: 'assistant', content: '¡Hola! Soy tu asistente. Pregúntame cómo usar el Diagramador, generar código o PDF, etc.' }
  ])
  ...
  const send = async () => {
    ...
    try {
      ...
      setMessages(m => [...m, { role: 'assistant', content: 'Ups, no pude responder ahora. Intenta de nuevo.' }])
      console.error(e)
    } finally {
      setLoading(false)
    }
